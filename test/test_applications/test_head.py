...
class TestCat(unittest.TestCase):
    ...
    def test_head_no_flag_no_args(self):
        output, curr_input, args, result = initialize_test_values()
    ...
    def test_head_n1(self):
        ...
        self.assertEqual(output.output.popleft(), "0\n")
        self.assertEqual(len(output.output), 0)
    ...
    def test_grep_with_wrong_flag_should_raise_exception(self):
        output, curr_input, args, result = initialize_test_values()
    ...
    def test_grep_with_multiple_files_should_raise_exception(self):
        output, curr_input, args, result = initialize_test_values()
